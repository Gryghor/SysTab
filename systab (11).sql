...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09/07/2025 às 19:42
...
(15, 208565, '355637050173616', 18, 3, 78),
(17, 203323, '355637053618971', 20, 1, 9),
(18, 211454, '355637053688479', 23, 1, 87),
(19, 203232, '355637053245551', 24, 1, 50);
...
(18, '075.624.594-01', 'Torgana Rizomar Tenorio da Silva', '(81) 98345-7137'),
(20, '065.261.214-89', 'Geise Da Costa Nascimento', '(81) 99236-3334'),
(22, '000.000.000-00', 'Não Cadastrado', ''),
(23, '111.430.924-90', 'Emmanuel Franciego da Silva Santos', '(81) 98339-8493'),
(24, '030.419.924-93', 'Edilma Maria da Silva', '(81) 99916-9200');
...
--
ALTER TABLE `chamados`
  MODIFY `idChamado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `tablets`
  MODIFY `idTab` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de tabela `unidades`
--
ALTER TABLE `unidades`
  MODIFY `idUnidade` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;
